...
/**
 * This is the extension manager of the Epsalesb2bcommerceservices extension.
 */
public class Epsalesb2bcommerceservicesManager extends GeneratedEpsalesb2bcommerceservicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(Epsalesb2bcommerceservicesManager.class.getName());
	 ...
	 */
	public static Epsalesb2bcommerceservicesManager getInstance()
	{
		return (Epsalesb2bcommerceservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				Epsalesb2bcommerceservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Epsalesb2bcommerceservicesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Epsalesb2bcommerceservicesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of Epsalesb2bcommerceservicesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of Epsalesb2bcommerceservicesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
